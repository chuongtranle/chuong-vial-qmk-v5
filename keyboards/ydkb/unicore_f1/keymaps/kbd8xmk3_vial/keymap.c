...
enum _custom_macos_keycode {
#ifdef VIA_ENABLE
    KC_MISSION_CONTROL = USER04,
#else
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = {
    ...
    {KC_LEFT, KC_RCTRL, LT(_FN, KC_APPLICATION), KC_DOT, KC_SLASH, KC_RSHIFT, KC_KP_2, KC_UP},
  ...
  [_FN] = {
    {KC_TRNS, KC_BRID, KC_BRIU, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPRV},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS},
    {KC_TRNS, RGB_VAI, RGB_SAI, RGB_HUI, KC_TRNS, DF(_MAC_LAYER), KC_TRNS, KC_TRNS},
    ...
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_NO},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO},
    {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO}
  }, 
  [_MAC_LAYER] = {
    {KC_ESCAPE, KC_BRID, KC_BRIU, KC_MCTL, KC_LPAD, KC_CURA, LSG(KC_4), KC_MPRV},
    {KC_GRAVE, KC_7, KC_6, KC_5, KC_4, KC_3, KC_2, KC_1},
    {KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_CAPSLOCK},
    {KC_LSHIFT, KC_H, KC_G, KC_F, KC_D, KC_S, KC_A, KC_NONUS_BSLASH},
    {KC_LCTRL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LGUI, KC_LALT},
    {KC_SPACE, KC_N, KC_M, KC_COMMA, KC_NO, KC_NO, KC_RGUI, KC_RALT},
    {KC_LEFT, KC_RCTRL, LT(_MAC_FN, KC_APPLICATION), KC_DOT, KC_SLASH, KC_RSHIFT, KC_KP_2, KC_UP},
    {KC_NO, KC_QUOTE, KC_SCOLON, KC_L, KC_K, KC_J, KC_ENTER, KC_NO},
    {KC_BSLASH, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET, KC_RBRACKET, KC_DELETE},
    {KC_INSERT, KC_KP_1, KC_BSPACE, KC_EQUAL, KC_MINUS, KC_0, KC_9, KC_8},
    {LSG(KC_4), KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_NO},
    {KC_END, KC_PGDOWN, KC_HOME, KC_PGUP, KC_SCROLLLOCK, KC_PAUSE, KC_DOWN, KC_RIGHT},
    {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO},
    {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO}
  }, 
  [_MAC_FN] = {
    ...
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS},
    {KC_TRNS, RGB_VAI, RGB_SAI, RGB_HUI, KC_TRNS, KC_TRNS, DF(_BASE), KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_HUD, RGB_SAD, KC_TRNS, KC_TRNS},
    {KC_TRNS, RGB_VAD, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSG(KC_4), KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {LSG(KC_3), KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
    {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO},
    {KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO}
  },
